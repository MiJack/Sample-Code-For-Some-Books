...
import com.iangclifton.auid.appendixc.sections.SectionAdapter;
...
public class SectionListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Create Adapter
		final ListAdapter adapter = new SectionAdapter(getActivity(), sections);
	...
	public void onListItemClick(ListView listView, View view, int position, long id) {
		...
		final SectionAdapter adapter = (SectionAdapter) getListAdapter();
